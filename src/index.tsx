...
const adminUserRoutes = () => (
  <Route path="/" component={App} >
    ...
    <Route path="/new" component={AddEditEventContainer} onEnter={requireLogin} />
    ...
    <Route path="events/:id/addexpense" component={AddExpenseContainer} onEnter={requireLogin} />
    <Route path="events/:id/edit" component={AddEditEventContainer} onEnter={requireLogin} />
